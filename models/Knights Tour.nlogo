...
to tour [N]
  ...
  if not netprologo:run-query prolog-query
  [user-message "There is no solution" stop]
...
; Procedure to move the knight according to a list of positions
...
Content of Knights-Tour.pl file (Prolog source code slightly modified from [here](http://www.ic.unicamp.br/~meidanis/courses/mc336/2009s2/prolog/problemas/))
...
false
0
Line -16777216 false 75 255 210 255
...
Rectangle -7500403 true true 75 255 195 300
Rectangle -16777216 false false 75 255 195 300
