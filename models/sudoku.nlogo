...
; Create a New Puzzle with Nr visible digits
to create-puzzle [Nr]
  ca
  no-display
...
; Auxiliary report to use an annonymous variable for the empty spaces
to-report content
  ifelse plabel = ""
  [report "_"]
  [report plabel]
...
; Procedure to solve a puzzle
to solve-sudoku
  let r netprologo:run-next
  let Sol netprologo:dereference-var "Sol"
  list-to-puzzle Sol
end
@#$#@#$#@
GRAPHICS-WINDOW
